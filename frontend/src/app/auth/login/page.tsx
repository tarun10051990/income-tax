    ...
    <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted mt-2">Log in to continue filing your tax return</p>
        </div>
        ...
        <div className="bg-surface rounded-xl border border-border p-6">
          ...
          <div className="flex rounded-lg bg-gray-100 p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${
                method === "email" ? "bg-surface shadow-sm text-foreground" : "text-muted"
              }`}
            >
              Email
            </button>
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${
                method === "phone" ? "bg-surface shadow-sm text-foreground" : "text-muted"
              }`}
            >
              Mobile OTP
            </button>
          ...
          {error && (
            <div className="bg-red-50 text-danger text-sm px-4 py-2 rounded-lg mb-4">
              {error}
            </div>
          )}
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-700">
              <strong>Demo:</strong> Use <code className="bg-blue-100 px-1 rounded">demo@taxfiler.in</code> with any password,
              or <code className="bg-blue-100 px-1 rounded">admin@taxfiler.in</code> for admin access.
            </p>
          </div>
        </div>
      </div>
